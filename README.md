...
├── tests/                       # Unit tests
├── datasets/                    # Dataset alignment files & metadata
├── artifacts/                   # Training outputs & evaluation results
